...
covid_cases <- tibble(name=c("Santa Barbara" , "Goleta", "Santa Maria","O","SP","F"), loc=c(1,2,3,1,2,3), pop=c(92100,31100,107000,20379,33751,18731) , cases=c(14721,5079,22741,3638,12180,6913),county=c(1,1,1,2,2,2)) %>%view()
